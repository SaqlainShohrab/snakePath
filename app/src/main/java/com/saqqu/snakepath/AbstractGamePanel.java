...
import com.saqqu.snakepath.threads.BaseGameThread;
import com.saqqu.snakepath.threads.TimerGameThread;

public abstract class AbstractGamePanel extends SurfaceView implements SurfaceHolder.Callback {
	protected BaseGameThread gameThread;
	private Paint paint;
	...
	public AbstractGamePanel(Class<? extends BaseGameThread> loopClass, Context context) {
		...
		setWillNotDraw(true);
		// setup brush
		panelColor = ContextCompat.getColor(context, R.color.colorFrag);
		paint = new Paint();
	}
